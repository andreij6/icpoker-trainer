        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-white/10 px-6 py-3">
            ...
            <div className="flex justify-end items-center gap-4">
                <button className="flex items-center justify-center rounded-lg h-10 bg-white/10 text-white text-sm font-bold leading-normal tracking-[0.015em] px-4">
                 ...
                 <button className="flex items-center justify-center gap-2 rounded-lg h-10 bg-white/5 border border-white/10 text-white text-sm font-bold leading-normal tracking-[0.015em] px-4">
                    <span className="material-symbols-outlined text-lg opacity-60">account_balance_wallet</span>
                    <span className="text-white/60">a1b2...c3d4</span>
                </button>
            </div>
        </header>
    );
